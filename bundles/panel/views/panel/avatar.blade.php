...
@section('panel_content')
	...
	<table>
		<tr>
			<td>
				<img src="" style="width:90px; height:90px; border:1px solid black" id="placeholder"/>
			</td>
				...
				<div class="control-group">
		        	<div class="controls">
		            	<div class="input-prepend input-append">
		              		...
		              		<input class="span3" id="email" name="email" type="text" placeholder="Adresse Email" value="{{ Input::old('email', Auth::user()->email) }}">
...
jQuery(document).ready(function(){
	...
	{
		$('#placeholder').attr('src', 'http://www.gravatar.com/avatar/'+$.md5($('#email').val()));
	}

	$('#email').keyup(function(){
		delay(updateAvatar, 1000);
	});

	updateAvatar();

	$("#valider").click(function(){
		$.post('{{ URL::to_action('panel::avatar@submit') }}', {email: $('#email').val()}, null, 'json')
		.done(function(json){
			$('#errorZone').hide();
